...
const warclock_scheduler_1 = require("./warclock-scheduler");
let TaskScheduler = class TaskScheduler {
    constructor(wcScheduler) {
...
TaskScheduler = __decorate([
    ...
    __param(0, inversify_1.inject(types_1.TYPES.WarclockScheduler)),
    __metadata("design:paramtypes", [warclock_scheduler_1.WarclockScheduler])
], TaskScheduler);
