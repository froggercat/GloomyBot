...
let help = {};
help[warclock_commands_1.default.id] = id_help;
help[warclock_commands_1.default.help] = help_help;
help[warclock_commands_1.default.list] = list_help;
help[warclock_commands_1.default.reset] = reset_help;
help[warclock_commands_1.default.set] = set_help;
help[warclock_commands_1.default.start] = start_help;
help[warclock_commands_1.default.stop] = stop_help;
help['default'] = default_help;
help['failure'] = abject_fail_help;
let error = {};
error[warclock_commands_1.default.id] = id_err;
error[warclock_commands_1.default.help] = "";
error[warclock_commands_1.default.list] = list_err;
error[warclock_commands_1.default.reset] = "";
error[warclock_commands_1.default.set] = "";
error[warclock_commands_1.default.start] = "";
error[warclock_commands_1.default.stop] = "";
error['default'] = "";
error['failure'] = "";
let cmd_keys = [
    ...Object.keys(warclock_commands_1.default).filter(key => !isNaN(Number(warclock_commands_1.default[key]))).map(key => warclock_commands_1.default[key]),
    ...['default', 'failure']
];
exports.default = [
    ...cmd_keys.map(cmd => {
...
//# sourceMappingURL=warclock-strings.js.map