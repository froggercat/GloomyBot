...
(function (WarclockCommand) {
    WarclockCommand[WarclockCommand["help"] = 0] = "help";
    WarclockCommand[WarclockCommand["id"] = 1] = "id";
    WarclockCommand[WarclockCommand["list"] = 2] = "list";
    WarclockCommand[WarclockCommand["start"] = 3] = "start";
