...
const server_details_finder_1 = require("./services/server-details-finder");
...
container.bind(types_1.TYPES.ServerDetailsFinder).to(server_details_finder_1.ServerDetailsFinder).inSingletonScope();
